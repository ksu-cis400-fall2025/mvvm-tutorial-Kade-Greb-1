...
namespace MvvmExample
{
    public class ComputerScienceStudentViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Event handler for handling pass-forward events form the student.
        /// </summary>
        /// <param name="sender">The student that is changing</param>
        /// <param name="e">An event args describing the changing property</param>
        private void HandleStudentPropertyChange(object? sender, PropertyChangedEventArgs e)
        {
        ...
        {
            _student = student;
            student.PropertyChanged += HandleStudentPropertyChange;
        }
    }
}
